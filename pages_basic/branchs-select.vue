		...
		<view style="position: fixed;width: 100vw;z-index: 999;" :style="{'top': CustomBar + 'px'}"
			...
			<view class="u-m-p-50">
				<view class="u-demo-area u-flex u-row-center">
					<!-- 部门 -->
					<luyj-data-picker style="width: 50%;" :value="search.orgId" :placeholder="i18n_merchant.branch.orgPlaceholder"
						:border="false" :preload="true" :localdata="organtrees" 
			...
			<teleport v-if="!isSearch">
				<u-index-list :scrollTop="scrollTop" :index-list="indexList">
					<view v-for="(item, index) in list" :key="index">
						...
						<view class="list-cell u-border-bottom" v-for="(item1, i) in item.data" :key="i"
...
<script>
	...
	export default {
		...
		methods: {
			 ...
			 */
			search_branchs : function(first = true){
